...
const Genre = () => {
  ...
  const currentUrl = `https://api.themoviedb.org/3/discover/movie?api_key=31af07621087a710376eeeff33ef9885&language=en-US&sort_by=popularity.desc&with_genres=${genreID}&with_watch_monetization_types=flatrate`
